...
def train():
    ...
    for i in range(N_EPOCHS):
        ...
        agent.update(memory)
        memory.reset()
    torch.save(agent.net, '/Users/xmm/PycharmProjects/pythonProject/rl4uc-master/rl4uc/data/weights/{}_gens_weights4.pth'.format(env.num_gen))
    return agent, log


agent, log = train()
pd.Series(log['mean_reward']).rolling(50).mean().plot()
plt.savefig('/Users/xmm/PycharmProjects/pythonProject/rl4uc-master/rl4uc/data/results/weight4.png')
plt.show()
