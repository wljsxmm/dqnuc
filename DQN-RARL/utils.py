...
if __name__ == '__main__':
    ...
    average = np.load(File_path + '/average_test11.npy')
    weight = np.load(File_path+'/weighted_test11.npy')
    reward = np.load(File_path+'/reward_test11.npy')
    ...
    plt.plot(np.arange(3000,episode), average[3000:])
